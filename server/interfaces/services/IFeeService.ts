...
export interface IFeeService {
  ...
  getVouchers(ctx: RequestContext, month?: string): Promise<any[]>;
  getConfigurations(ctx: RequestContext): Promise<any[]>;
  configure(ctx: RequestContext, data: any): Promise<void>;
}
